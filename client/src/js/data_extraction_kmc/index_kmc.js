...
// Event listener for "Generate Tables" button
document.getElementById('generate-tables').addEventListener('click', function() {
    const csv = localStorage.getItem('csvData');
    if (!csv) {
        showCustomAlert('No data available for generate tables !');
        return; // Stop redirection if no data
    }
...
document.getElementById('calculate').addEventListener('click', function() {
    const csv = localStorage.getItem('csvData');
    if (!csv) {
        showCustomAlert('No data available for calculation !');
        return; // Stop redirection if no data
    }
